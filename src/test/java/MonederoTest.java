...
public class MonederoTest {
    ...
    Cliente c = new Cliente("Luis", "3891282", "cll 23-32", "luis@gmail.com", 25,"5543");

    @Test
    void testDepositarAumentaSaldo() {
        Monedero m = new Monedero(c, 100000, "3312", TipoMonedero.AHORROS);
        m.depositar(50000);
    ...
    void testRetiroValido() {
        Monedero m = new Monedero(c, 200000, "3312", TipoMonedero.AHORROS);
        m.retirar(80000);
    ...
    void testRetiroInvalido() {
        Monedero m = new Monedero(c, 30000, "3312", TipoMonedero.AHORROS);
        m.retirar(100000);
